    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-10 mx-auto">
                <h3 class="text-uppercase"><strong class="d-lg-flex justify-content-lg-center" style="color: rgb(255,255,255);">000 error</strong></h3>
                <hr>
            </div>
        </div>
        <div class="row">
            <div class="col">
                <div class="jumbotron" style="background-color: rgba(233,236,239,0);">
                    <div class="col-auto col-lg-8 text-dark mx-auto" style="background-color: rgba(15,15,15,0.8);padding-top: 20px;padding-bottom: 20px;">
                        <div class="row">
                            <div class="col text-center" style="color: rgb(255,255,255);margin-bottom: -15px;"><label class="col-form-label">Some description.</label></div>
                        </div><br>
</div>
                    <p></p>
                </div>
