...
<body style="background-image: url(../../assets/img/header-3.jpg);">
    ...
    <div class="container">
        <div class="row" style="margin-top: -5%;">
            <div class="col-lg-10 mx-auto">
                <h3 class="text-uppercase"><strong class="text-center d-flex d-lg-flex align-items-center justify-content-lg-center" style="color: rgb(255,255,255);">Email checker</strong></h3>
                <hr>
            </div>
        </div>
        <div class="row" style="margin-bottom: 10px;">
            <div class="col" style="margin-bottom: 6%;">
                <div class="jumbotron" style="background-color: rgba(233,236,239,0);">
                    <div class="col-auto col-lg-8 text-dark mx-auto" style="background-color: rgba(15,15,15,0.8);padding-bottom: 15px;width: 350px;">
                        <form>
                        ...
                        <div class="row">
                            <div class="col d-lg-flex justify-content-lg-center align-items-lg-center" style="background-image: url(../../assets/img/checked.png);background-size: contain;height: 250px;width: 250px;background-repeat: no-repeat;background-position: center;"><img></div>
                        </div><br>
</div>
                    <p></p>
                </div>
