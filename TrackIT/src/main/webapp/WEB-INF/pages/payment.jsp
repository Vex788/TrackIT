        ...
        <div class="container my-auto">
            ...
            <div class="col-auto col-lg-8 text-dark mx-auto" style="background-color: rgba(15,15,15,0.8);padding: 15px;padding-top: 20px;padding-bottom: 20px;">
                <form>
                    ...
                    <div class="form-row">
                        <div class="col-lg-12 offset-lg-0 d-inline-flex d-lg-flex justify-content-lg-center"><input class="bg-dark border-dark shadow form-control" type="url" name="card_number" placeholder="Enter card number" inputmode="numeric" style="font-family: 'Open Sans', sans-serif;color: rgb(255,255,255);margin-right: 5px;">
                            <input
                                class="bg-dark border-dark shadow form-control d-lg-flex justify-content-lg-end" type="text" name="cvc" placeholder="Enter CVC" inputmode="numeric" style="width: 40%;font-family: 'Open Sans', sans-serif;color: rgb(255,255,255);"></div>
                    </div>
                </form>
                <div class="row">
                ...
                <div class="row">
                    <div class="col"><button class="btn btn-success btn-lg bg-success border rounded border-success shadow" type="button" id="report_a_drop" style="font-family: 'Open Sans', sans-serif;font-style: normal;font-weight: normal;width: 35%;color: rgb(0,0,0);">pay</button></div>
                </div>
            </div>
        </div>
    </header>
